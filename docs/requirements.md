...
CA-REQ-074|Security|Financial data types are handled safely with regard to integer overflows, floating point errors|''
...
CA-REQ-074|General Security|Safe financial data handling|code review (talk aloud)
